...
CONFIG: dict[str, Any] = {
    ...
    "opt_dir": "/Volumes/OneTouch/01p_Schmahmann_SCA_Atrophy/results/optimzation/TotalCCASRawScore",
    ...
    "predictor_col": "TotalCCASRawScore",  #AffectFailS # TotalCCASRawScore
    "passes": 15,
    "seed": 0,
    "cv": "loocv",
    "n_permutations": 0,
    "drop_nans": ["TotalCCASRawScore"],
    "verbose": True,
}
